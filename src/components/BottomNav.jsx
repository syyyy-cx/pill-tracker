...
const TABS = [
  { key: 'home', label: '打卡', icon: ICONS.home },
  { key: 'stats', label: '统计', icon: ICONS.stats },
  { key: 'achievements', label: '成就', icon: ICONS.achievements },
  { key: 'chat', label: '消息', icon: ICONS.chat },
  { key: 'contract', label: '契约', icon: ICONS.contract },
]
